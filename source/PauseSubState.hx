...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		music = new FlxSound().loadEmbedded(Paths.music('breakfast'));
		music.play();
		music.volume = 0;
		music.persist = false;
		FlxTween.tween(music, {volume: 0.6}, 7.5, {ease: FlxEase.linear, startDelay: 2.5});
